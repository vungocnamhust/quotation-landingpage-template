...
| **15.3** | Rates: `rates` + `rate_price_lines` + supersede flow + UI nhập giá trong product drawer; pure `core/rules/rate_selection.py` | ❌ Không | Nhập bảng giá mùa vụ, đổi giá không phá giá cũ |
