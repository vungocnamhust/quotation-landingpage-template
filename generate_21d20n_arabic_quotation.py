...
payload = {
    ...
    "quotationNarrative": (
        ...
        "من سحر هانوي التاريخي ونقاء خليج هاليغ، إلى مرتفعات سابا الشامخة، وصولاً إلى شواطئ دا نانغ الرملية "
    ...
    "journeyGlance": {
        ...
        "domesticFlights": "مشمولة (هانوي - دا نانغ، دا نانغ - nha trang، نها ترانغ - هو تشي منه)",
