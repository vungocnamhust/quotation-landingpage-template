...
function resolveScope({
  ...
  return {
    ...
    style: {
      ...
      '--color-map-header-veil': resolved.mapOverlay
        ? withOpacity(palette[resolved.mapOverlay.header.surface], resolved.mapOverlay.header.opacity)
        : 'transparent',
      '--color-map-footer-veil': resolved.mapOverlay
        ? withOpacity(palette[resolved.mapOverlay.footer.surface], resolved.mapOverlay.footer.opacity)
        : 'transparent',
      '--color-map-marker-veil': resolved.mapOverlay
        ? withOpacity(palette[resolved.mapOverlay.marker.surface], resolved.mapOverlay.marker.opacity)
        : 'transparent',
      '--color-map-canvas-veil': resolved.mapCanvasVeil
        ? withOpacity(palette[resolved.mapCanvasVeil.surface], resolved.mapCanvasVeil.opacity)
        : 'transparent',
      '--filter-map-tiles': resolved.mapTileTreatment
        ? MAP_TILE_FILTERS[resolved.mapTileTreatment]
        : 'none',
